...
async def get_user_id_page(
        # исправлен параметр минимальной длины - был gt (больше чем), изменен на ge (больше или равно)
...
async def get_user_info_page(
        # исправлены параметры минимальной и максимальной длины username (вместо gt и le (применяются
        # к числовым данным), использованы min_lenght и max_lenght для строковых данных)
        username: Annotated[str, Path(
            min_length=5,
            max_length=20,
            description="Enter username",
            example="UrbanUser" )],
        # исправлен параметр минимального возраста - был gt (больше чем), изменен на ge (больше или равно)
